...
START_ANGLE = 0  # degrees (0 initially)
target_mode = 'fix'  # Mode for angular shift of target: random, fix, dynamic

Interval_General = (5, 10)  # Interval for perturbations
...
save_list_to_csv(error_angles,
                 file_name=f'error_angles_{'Mask' if mask_mode else 'NoMask'}_StartAngle_{START_ANGLE}_Target_{target_mode}.csv')
